...
vim.keymap.set('n', '<A-v>', '<C-v>', { noremap = true, silent = true, desc = 'Visual Block mode' })
vim.keymap.set('x', '<A-v>', '<C-v>', { noremap = true, silent = true, desc = 'Visual Block mode' })
...
vim.api.nvim_create_autocmd('TermOpen', {
  desc = 'Crates new Terminal',
  group = vim.api.nvim_create_augroup('custom-term-opener', { clear = true }),
  callback = function()
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', 'gp', 'mpGVgg"+p`p', { desc = 'Paste into the file from system clipboard' })
  ...
  { -- Autocompletion
    ...
    opts = {
      ...
      sources = {
        ...
        default = { 'obsidian_new', 'obsidian_tags', 'obsidian', 'lsp', 'path', 'snippets', 'lazydev' },
        providers = {
